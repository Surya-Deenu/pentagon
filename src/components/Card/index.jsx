      ...
      <div className="container-fluid">
        <div className="card-projects">
          ...
          <div className="card-projects-carousel">
            <div className="d-flex justify-content-center align-items-center flex-wrap gap-3 projects-cards">
              <div className="">
                <div className="card image-devide-contant">
                  <img
                    className="card-projects-image"
                    src={jubliant}
                    alt="Card image"
                  />
