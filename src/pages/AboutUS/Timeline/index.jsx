    ...
    <>
      <div className="timelene-section">
        ...
        >
          ...
          <div className=" container-fluid p-0 tab-timeline">
            <Slider {...settings}>
              <div>
                ...
                <div className=" text-center buttom-content-fix">
                  ...
                  <p className="slide-buttom-timeline">
                    Booked a Mixed development project of 1.8 Million Sqft -
                    Rupa Renisance, which includes 120 Keys Mariott Executive
              ...
              <div>
                <div className="timeline-top">
                  <div className="top-content-border">
                    ...
                    <p className="slide-prah-timeline">
                      Parle Agro selected Pentagon to revamp their plant rooms
                      at 7 different locations in india for more than 5000 tons
              ...
              <div>
                ...
                <div className="text-center buttom-content-fix">
                  ...
                  />
                  <p className="slide-buttom-timeline">
                    Booked 2 Million Sqft - Empire Towers in Navi Mumbai with
                    4000 Tons chilled water capacity
                  </p>
                </div>
              </div>
              <div>
                <div className="timeline-top">
                  <div className="top-content-border">
                    ...
                    <p className="slide-prah-timeline">
                      Booked Jupiter Hospital - Pune which was awarded first
                      Indo Swiss Building Efficiency Project ( BEEP ) in India
                    </p>
                  </div>
                </div>
                <div className="text-center buttom-content-fix">
          ...
          <div className="mobile-timeline">
            <Slider {...settings}>
              <div className="top">
                ...
                <div className=" text-center buttom-content-fix">
                  <img
                    src={year2020}
                    alt="images"
                    className="mw-100 silde-image-timelie "
                  />
                  <p className="slide-buttom-timeline">
                    Awarded By Carrier - Highest Selling Dealer Pan India for
                    Toshiba VRF System
              ...
              <div className="buttom">
                <div className="timeline-top">
                  <div className="top-content-border pt-4 ">
                    <img src={year2019} alt="images" className="mw-100 " />
                    <p className="slide-prah-timeline ">
                      Booked a Mixed development project of 1.8 Million Sqft -
                      Rupa Renisance, which includes 120 Keys Mariott Executive
                      apartments and 35 Floor commercial tower
                ...
                <div className=" text-start buttom-content-fix ">
                  <img
                    src={year2019}
                    alt="images"
                    className="mw-100 silde-image-timelin"
              ...
              <div className="buttom">
                <div className="timeline-top">
                  <div className="top-content-border pt-4 ">
                    <img src={year2017} alt="images" className="mw-100 " />
                    <p className="slide-prah-timeline ">
                      Started Retrofit division, which successfully completed
                      some of the prominet projects like J W Mariott, ICICI
                      Bank, Jacob House, Four Point shereton
                    </p>
                  </div>
                </div>
                <div className=" text-start buttom-content-fix ">
              ...
              <div className="buttom">
                <div className="timeline-top">
                  <div className="top-content-border pt-4 ">
                    <img src={year2015} alt="images" className="mw-100 " />
                    <p className="slide-prah-timeline ">
                      Booked 2 Million Sqft - Empire Towers in Navi Mumbai with
                      4000 Tons chilled water capacity
                    </p>
              ...
              <div className="buttom">
                <div className="timeline-top">
                  <div className="top-content-border pt-4 ">
                    <img src={year2013} alt="images" className="mw-100 " />
                    <p className="slide-prah-timeline ">
                      Lodha selected Pentagon to execute HVAC works for their
                      tallest Tower In India - World Towers
                    </p>
              ...
              <div className="buttom">
                <div className="timeline-top">
                  <div className="top-content-border pt-4 ">
                    <img src={year2011} alt="images" className="mw-100 " />
                    <p className="slide-prah-timeline ">
                      Booked one of the largest VRF Project In Mumbai for
                      Toshiba Airconditioning for 6000 Tons Capacity
                    </p>
                  </div>
                </div>
                <div className=" text-start buttom-content-fix ">
