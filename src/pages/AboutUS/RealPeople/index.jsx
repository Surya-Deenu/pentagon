...
import person from '../../../assets/directors/D. FrancisSagaya Raj.png'
                    ...
                    <div className='row peoplewhomadeImg justify-content-center justify-content-md-start'>
                        <div className='col-md-6 people-details'>
                            ...
                            <div className='text-center pt-3'>
                                <h5><b>D.Francis sagaya raj</b></h5>
                                <h6>Director</h6>
                            </div>
                        </div>
                        <div className='col-md-6 people-details'>
                        ...
                        <img src={personTree} alt="person" className='mw-100' />
                            <div className='text-center pt-3'>
                                <h5><b>Sanjay malkar</b></h5>
                                <h6>Director</h6>
                            </div>
                        </div> <div className='col-md-6 people-details pt-3'>
                        <img src={personFour} alt="person" className='mw-100' />
                            <div className='text-center pt-3'>
                                <h5><b>Yogesh bansode</b></h5>
                                <h6>Director</h6>
                            </div>
                        </div> <div className='col-md-6 people-details pt-4 pb-4'>
